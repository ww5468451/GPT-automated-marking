...
def main(url):
    ...
    #     time.sleep(3.0)
        ...
        # product_descriptions = title_text + products + five_dec + product_description
        ...
        #
        # products_description = shuoming+products+five_dec+page_text+product_description
        product_descriptions = products + five_dec + product_description + product_
        print(product_descriptions)
        if product_descriptions != '':
            # if 'motion sensor light' in product_description.lower() or 'motion' in product_description.lower() or 'sensor' in product_description.lower():
            #     sport_light = '带运动传感灯'
...
def get_url():
    ASIN0 = open('ASIN1.txt', 'r+', encoding='utf-8')
