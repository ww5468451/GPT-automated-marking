...
chrome_options.add_argument(r'--user-data-dir=C:\Users\admin\AppData\Local\Google\Chrome\User Data4')
...
def main(url):
    ...
    def have_product():
        ...
        if product_descriptions != '':
            ...
            #
            # try:
            #     gonglv = re.search(r'(\d+,?\d+)(?:\s*BTU|\s*British Thermal Units)', product_descriptions).group(1)
            # except:
            #     gonglv = ' '
            #
            # try:
            #     zaoyin = re.search(r'(?:Noise Level |Noise )(\d+)', product_descriptions).group(1)
            # except:
            #     zaoyin = " "
...
def get_url():
    ASIN0 = open('ASIN2.txt', 'r+', encoding='utf-8')
...
if __name__ == '__main__':
    ...
    for url in urls:
        ...
        time.sleep(random_num)
        if text != '':
            asin_product = open('ASIN_Products2.txt', 'a+', encoding='utf-8')
            try:
                print(ASIN + "#" + text)
